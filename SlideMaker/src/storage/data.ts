...
const img1: ImageObj = createImgSlideObj(
    { x: 200, y: 140 },
    { w: 150, h: 180 },
    "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTh6G5ZoAKwc2A_8NEaiGWClkMoxVo_0xUf8Q&s",
);
...
slide2 = changeBackgroundToImage(slide2, {
    type: BgType.image,
    url: "https://avatars.mds.yandex.net/i?id=dd140583fc56ad01241b887adfee0161_l-4770953-images-thumbs&n=13",
});
...
const defaultEditor: EditorType = savedEditorState
